...
export function createListConnectionsCommand(): Command {
...
export function createJpsCommand(): Command {
...
export function createArthasAttachCommand(): Command {
  return new Command('attach')
    ...
    .action(async (connectionId: string, pid: string) => {
...
export function createArthasCommand(): Command {
...
export function createAICommand(): Command {
  ...
  ai
    ...
    .action(async (sessionId: string, question?: string) => {
      ...
      try {
        const result = await aiService.analyzePerformance(
          sessionId,
          question || 'Please analyze the current performance of this Java application and provide optimization suggestions.'
        );
